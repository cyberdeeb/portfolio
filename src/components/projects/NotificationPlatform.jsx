      ...
      <div className="border-b border-gray-800">
        <div className="max-w-4xl mx-auto px-6 py-6 flex items-center justify-between">
          ...
          <a
            ...
            className="flex items-center gap-2 text-sm border border-gray-700 hover:border-gray-500 px-4 py-2 rounded transition-colors"
          >
 ...
 Resend   Textbelt    On failure (nack)
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {services.map((service) => (
              <div
                key={service.name}
                className="border border-gray-800 rounded-lg p-6 space-y-2 hover:border-gray-600 transition-colors"
              >
                <div className="flex items-center gap-3">
        ...
        <div className="border-t border-gray-800 pt-12 flex items-center justify-between">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-sm bg-white text-black px-6 py-2 rounded hover:bg-gray-200 transition-colors font-medium"
          >
            View on GitHub
          </a>
        </div>
