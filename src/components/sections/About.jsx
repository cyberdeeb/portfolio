            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-1">
                ...
                <p className="text-gray-300">
                  ...
                  enhanced data accuracy, cross-team visibility, and stakeholder
                  decision making.
                </p>
              </div>
              <div className="flex flex-col gap-1">
                ...
                <p className="text-gray-300">
                  ...
                  satisfaction, and data driven decision making while mentoring
                  new hires on SQL and Tableau best practices.
                </p>
              </div>
            </div>
          </div>
